...
from apps.messaging.views import MessageViewSet, conversation_messages_view, whatsapp_webhook_mock, pending_messages_view, send_manual_message_view
...
urlpatterns = [
    ...
    path("api/conversations/<int:conversation_id>/send-manual/",send_manual_message_view),
